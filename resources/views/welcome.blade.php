        ...
        <div class="relative min-h-screen grid-bg overflow-hidden bg-gray-100">
            ...
            <main class="relative z-10 flex flex-col items-center justify-center px-6 pt-16 pb-20 sm:pt-24 sm:pb-28 text-center">
                ...
                <h1 class="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight text-gray-900 max-w-3xl leading-[1.1]">
                    ...
                    <span class="text-indigo-500">without the boilerplate</span>
                </h1>
                ...
                <div class="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-2xl w-full">
                    <div class="rounded-xl border border-gray-200 bg-white/80 backdrop-blur-sm p-5 text-left shadow-sm">
                        <div class="w-8 h-8 rounded-lg bg-indigo-50 flex items-center justify-center mb-3">
                            <svg class="w-4 h-4 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M17.25 6.75 22.5 12l-5.25 5.25m-10.5 0L1.5 12l5.25-5.25m7.5-3-4.5 16.5" /></svg>
                        </div>
                    ...
                    <div class="rounded-xl border border-gray-200 bg-white/80 backdrop-blur-sm p-5 text-left shadow-sm">
                        <div class="w-8 h-8 rounded-lg bg-indigo-50 flex items-center justify-center mb-3">
                            <svg class="w-4 h-4 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z" /></svg>
                        </div>
